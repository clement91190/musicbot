...
\begin{frame}
    ...
    \begin{center}
        \begin{figure}
            \includegraphics[width=0.6\textwidth]{Figures/score_worth_connection.png} 
        \end{figure}
    \end{center}
...
\begin{frame}
    \frametitle{Correlation weight and worth of a connection}
...
\begin{frame}
    ...
    In this Chapter, we introduce Self-Growing Recurrent Neural Network (SGRNN), which is a Recurrent Neural Network that change its architecture as well as its weights during learning.
...
\begin{frame}
    ...
    We compare the learning curves of classical RNN with fixed number of neurons (20 (green and 50 (red)) and the SGRNN (blue)
        \begin{figure}
                \includegraphics[width=0.4\textwidth]{Figures/sgrnn_training.png} 
        \end{figure}   
    Demo : 
    \begin{itemize}
