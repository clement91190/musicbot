...
class ClemRNNHfOptim(BaseEstimator):
...
#            n_test = test_set_x.get_value(borrow=True).shape[0]
        ...
        gradient_dataset = SequenceDataset(
            [seq, targets], batch_size=None, number_batches=100)
